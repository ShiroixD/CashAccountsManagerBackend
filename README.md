...
Java 21 application for registering, managing actions from many accounts in different banks. This is simple example of application using many aspects of java programming language like core keywords, polymorphism, inheritance, abstraction, IO, collections and many others.
Application hierarchy is divided into three layers:
